...
public class LinguineLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ASIGNACION", "IF", "THEN", "ELSE", "FUNCION", "SHOW", "MATCH", "ORMATCH", 
			"WITH", "FOR", "WHILE", "DEFAULT", "FLECHA", "STRING", "COPY", "CONCAT", 
			"EXTRACT", "AND", "OR", "NOT", "XOR", "NAND", "ENTERO", "FLOAT", "IDENTIFICADOR", 
			"ABRECORCHETE", "CIERRACORCHETE", "ABRELLAVE", "CIERRALLAVE", "IGUAL", 
			"MAYORQUE", "MENORQUE", "MAYORIGUALQUE", "MENORIGUALQUE", "IGUALQUE", 
